...
The image above shows that the COST algorithm works the best because the algorithm waits for the low tariff zone (blue area) before charging the vehicle at a cheaper rate
