...
##################################################
def compareCars(filename, sim, algo, total_cars, company):
    ...
    plt.savefig(filename + '_' + algo + '_charge.png')
    plt.close('all')

#########################################################
# create graph to compare battery kW between algorithms
#########################################################
def compareAlgo(filename, sim, car, total_algos, company):
    ...
    plt.savefig(filename + '_car' + str(car) + '_charge.png')
    plt.close('all')
